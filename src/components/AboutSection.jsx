...
import { Target, Heart, Handshake, Shield, Brain, Award, Sparkles } from 'lucide-react'; // Certifique-se de importar todos os ícones necessários
  ...
  return (
    <section id="about" className="py-20 bg-gray-800">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Separador Visual entre História e Missão/Conduta */}
        <div className="my-20 border-b-2 border-blue-electric-500/30 w-3/4 mx-auto rounded-full" data-aos="zoom-in" data-aos-duration="1000"></div> {/* Divisor mais visível */}

        {/* Nossa Missão - Agora em um bloco próprio */}
        <div className="max-w-5xl mx-auto mb-20" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
          <div className="bg-gradient-to-br from-gray-700/60 to-gray-800/60 p-10 rounded-xl border-2 border-blue-electric-600/30 shadow-2xl hover:shadow-blue-electric-500/30 transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden group">
            ...
            <Target className="w-14 h-14 text-blue-electric-400 mb-6 mx-auto group-hover:scale-110 transition-transform duration-300" /> {/* Ícone maior e centralizado, com hover */}
        ...
        {/* Separador Visual entre Missão e Regras de Conduta */}
        <div className="my-20 border-b-2 border-blue-electric-500/30 w-3/4 mx-auto rounded-full" data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300"></div> {/* Divisor mais visível e atraso */}

        {/* Regras de Conduta - Agora em um bloco próprio */}
        <div className="max-w-5xl mx-auto mb-20" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
          <div className="bg-gradient-to-br from-gray-700/60 to-gray-800/60 p-10 rounded-xl border-2 border-blue-electric-600/30 shadow-2xl hover:shadow-blue-electric-500/30 transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden group">
             {/* Elemento de fundo sutil para efeito visual */}
            <div className="absolute inset-0 bg-blue-electric-900/10 opacity-0 group-hover:opacity-10 transition-opacity duration-500"></div>

            <Heart className="w-14 h-14 text-blue-electric-400 mb-6 mx-auto group-hover:scale-110 transition-transform duration-300" /> {/* Ícone maior e centralizado, com hover */}
            <h3 className="text-4xl font-extrabold mb-4 text-blue-electric-300 text-center uppercase tracking-wider">
